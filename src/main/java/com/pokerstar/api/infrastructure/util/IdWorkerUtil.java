...
public class IdWorkerUtil {
    ...
    private final static Logger logger = LoggerFactory.getLogger(IdWorkerUtil.class);

    private final long workerId;
    private final long epoch = 714356460666L;   // 时间起始标记点
    ...
    public synchronized String nextId() throws Exception {
        ...
        return RandomStringUtils.randomAlphanumeric(8) + (timestamp - this.epoch << this.timestampLeftShift | this.workerId << this.workerIdShift | this.sequence);
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (int i = 0; i < 100; i++) {
            IdWorkerUtil idWorker = IdWorkerUtil.getFlowIdWorkerInstance();
